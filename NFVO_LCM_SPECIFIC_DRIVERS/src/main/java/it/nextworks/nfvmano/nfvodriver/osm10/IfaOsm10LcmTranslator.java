...
public class IfaOsm10LcmTranslator {
    ...
    public static InstantiateNsRequest getInstantiateNsRequest(it.nextworks.nfvmano.libs.ifa.osmanfvo.nslcm.interfaces.messages.InstantiateNsRequest request,
                                                               String nsiName,
                                                               UUID nsdInfoId,
                                                               UUID vimId) {
        InstantiateNsRequest translation = new InstantiateNsRequest();

        translation.setNsName(nsiName);
        translation.setNsdId(nsdInfoId);
        translation.setVimAccountId(vimId);
        return translation;
