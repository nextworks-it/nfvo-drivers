...
public class TerminateNsiRequest {
  @SerializedName("terminationTime")
  private OffsetDateTime terminationTime = null;

  public TerminateNsiRequest terminationTime(OffsetDateTime terminationTime) {
    this.terminationTime = terminationTime;
    return this;
  }

   /**
   * Timestamp indicating the end time of the NSI, i.e. the NSI will be terminated automatically at this timestamp. Cardinality \&quot;0\&quot; indicates the NSI termination takes place immediately. 
   * @return terminationTime
  **/
  @Schema(description = "Timestamp indicating the end time of the NSI, i.e. the NSI will be terminated automatically at this timestamp. Cardinality \"0\" indicates the NSI termination takes place immediately. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TerminateNsiRequest terminateNsiRequest = (TerminateNsiRequest) o;
    return Objects.equals(this.terminationTime, terminateNsiRequest.terminationTime);
  }
  ...
  public String toString() {
    ...
    sb.append("class TerminateNsiRequest {\n");
