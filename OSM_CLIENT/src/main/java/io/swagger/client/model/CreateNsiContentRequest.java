...
public class CreateNsiContentRequest {
  ...
  public CreateNsiContentRequest nstId(UUID nstId) {
    this.nstId = nstId;
    return this;
  }
   ...
   * @return nstId
  **/
  @Schema(description = "Identifier of the NST that defines the NetSlice instance to be created. ")
  ...
  public CreateNsiContentRequest nsiName(String nsiName) {
   ...
   * @return nsiName
  **/
  @Schema(description = "Human-readable name of the NetSlice instance to be created. ")
  ...
  public CreateNsiContentRequest vimAccountId(UUID vimAccountId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateNsiContentRequest createNsiContentRequest = (CreateNsiContentRequest) o;
    return Objects.equals(this.nstId, createNsiContentRequest.nstId) &&
        Objects.equals(this.nsiName, createNsiContentRequest.nsiName) &&
        Objects.equals(this.vimAccountId, createNsiContentRequest.vimAccountId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(nstId, nsiName, vimAccountId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateNsiContentRequest {\n");
